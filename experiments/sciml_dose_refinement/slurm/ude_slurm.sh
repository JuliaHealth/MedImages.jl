...
#SBATCH --mem=128G
#SBATCH --output=/user/joanna.wybranska/u10867/.project/dir.project/MedImages.jl/experiment/sciml_dose_refinement/logs/ude/ude_%j.out
#SBATCH --error=/user/joanna.wybranska/u10867/.project/dir.project/MedImages.jl/experiment/sciml_dose_refinement/logs/ude/ude_%j.err
...
echo "Starting UDE Training on Slurm..."
