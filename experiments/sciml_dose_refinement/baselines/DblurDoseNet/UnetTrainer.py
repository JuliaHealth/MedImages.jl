    ...
    def train(self, train_loader, valid_loader):
        ...
        for i in range(self.num_epochs):
            ...
            if (i + 1) % 5 == 0:
                ...
                save_checkpoint(self.model.module.state_dict(), is_best= False, checkpoint_dir= os.getcwd() + '/checkpoint_res_2d_unet_shr/')
                torch.save(Loss_history, os.getcwd() + '/checkpoint_res_2d_unet_shr/train_loss.pt')
                torch.save(valid_loss_history, os.getcwd() + '/checkpoint_res_2d_unet_shr/valid_loss.pt')
