...
mode will indicate do we want to modify just the pixel array, spatial metadata or both
return the rotated MedImage object 
"""
function rotate_mi(im::Array{MedImage}, rotate_axis::Int64,angle::Float64, Interpolator::Interpolator,mode::Mode_mi)::Array{MedImage}
...
"""
function crop_mi(im::Array{MedImage}, crop_beg::Tuple{Int64,Int64,Int64}, crop_size::Tuple{Int64,Int64,Int64}, Interpolator::Interpolator,mode::Mode_mi)::Array{MedImage}
...
return the cropped MedImage object 
"""
function pad_mi(im::Array{MedImage}, pad_beg::Tuple{Int64,Int64,Int64}, pad_end::Tuple{Int64,Int64,Int64},pad_val, Interpolator::Interpolator,mode::Mode_mi)::Array{MedImage}
...
"""
function translate_mi(im::Array{MedImage}, translate_by::Int64, translate_in_axis::Int64, Interpolator::Interpolator,mode::Mode_mi)::Array{MedImage}
...
"""
function scale_mi(im::Array{MedImage}, scale::Tuple{Float64,Float64,Float64}, Interpolator::Interpolator,mode::Mode_mi)::Array{MedImage}
