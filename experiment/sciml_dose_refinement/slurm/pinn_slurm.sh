...
#SBATCH --mem=128G
#SBATCH --output=/user/joanna.wybranska/u10867/.project/dir.project/MedImages.jl/experiment/sciml_dose_refinement/logs/pinn/pinn_%j.out
#SBATCH --error=/user/joanna.wybranska/u10867/.project/dir.project/MedImages.jl/experiment/sciml_dose_refinement/logs/pinn/pinn_%j.err
