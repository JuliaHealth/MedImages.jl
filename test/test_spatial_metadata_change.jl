...
function test_change_orientation(path_nifti)
    ...
    for orientation in ["RAS","LAS" ,"RPI","LPI","RAI","LAI","RPS","LPS"]#,"RSP","RIP"
        ...
        sitk_im_raw=sitk.ReadImage(path_nifti)
        print("\n oooo orientation $(orientation) med_im $(med_im.direction) sitk  sitk_image $(sitk_im_raw.GetDirection())  enum $(string_to_orientation_enum[orientation])\n ")
